...
{
    class SarfMalz : Malzemeler, IPersoneller
    {
        ...
        // constructor :
        public SarfMalz(int malzKod, string kategori, string ad, int stokAdet)
        {
            MalzKod = malzKod;
            Kategori = kategori;
            Ad = ad;
        ...
        public SarfMalz(int perKod, string perAd, string perSoyad, string malzKategori, string malzAd, int istenenAdet)
        {
            PerKod = perKod;
            PerAd = perAd;
            PerSoyad = perSoyad;
